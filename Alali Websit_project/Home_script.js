(function() {
    ...
    const translations = {
        en: {
            ...
            // About
            about_title: "About ALALI Concepts", about_sub: "Established 2024",
            ...
            gender_m: "Men", gender_f: "Women", gender_u: "Unisex",
            ...
            footer_p1: "Your trusted partner for IT solutions, professional translation services, and legal consultation in Luxembourg.",
        ...
        fr: {
            ...
            // About
            about_title: "À Propos d'ALALI Concepts", about_sub: "Établi en 2024",
            ...
            gender_m: "Hommes", gender_f: "Femmes", gender_u: "Unisexe",
            ...
            tr_p: "Services de traduction experts dans plus de 10 langues par des locuteurs natifs certifiés.",
            lang_euro: "Langues Européennes", lang_other: "Autres Langues",
            ...
            it_p: "Solutions technologiques complètes pour optimiser vos opérations commerciales.",
        ...
        ar: {
            ...
            // About
            about_title: "حول ALALI Concepts", about_sub: "تأسست عام 2024",
            ...
            gender_m: "للرجال", gender_f: "للنساء", gender_u: "للجنسين",
            ...
            tr_p: "خدمات ترجمة خبيرة بأكثر من 10 لغات من قبل متحدثين أصليين معتمدين.",
    ...
    window.sortProducts = function() {
        ...
        cards.sort((a, b) => {
            ...
            return sortValue === 'low-high' ? getPrice(a) - getPrice(b) : getPrice(b) - getPrice(a);
        });
...
/**
 * 7. LOAD PRODUCTS (Shop page only)
 */
...
document.addEventListener('click', function(e) {
    if (e.target.closest('.card-overlay') && !e.target.closest('.card-overlay-inner')) {
        closeCardModal();
    }
});
